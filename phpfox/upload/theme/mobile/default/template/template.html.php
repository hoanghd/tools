	...
	<body>
		...
		<div id="mobile_holder">
			<div id="mobile_header">	
				...
				{if Phpfox::isUser()}
				<a href="{url link='notification'}" id="mobile_header_notification"><div class="holder"><div id="js_total_new_notifications">0</div><div class="inner">Notifications</div></div></a>
				{/if}
				{/if}
