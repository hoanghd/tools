 ...
 * @author			Raymond Benc
 * @package 		Phpfox
 * @version 		$Id: template.html.php 3208 2011-09-27 14:34:33Z Raymond_Benc $
 */
				...
				<div class="main_holder">
					<div id="main_top_inner">
						...
						<div id="user_info_link">
							{phrase var='admincp.logged_in_as' user=$aUserDetails} <span class="separator">|</span> <a href="{url link=''}">View Site</a>					
						</div>
					</div>
				</div>
			</div>
				...
				<div id="top_right">
					...
					<div id="admincp_search">
						<div id="admincp_search_inner">
							<div id="admincp_search_input_default_value">Search...</div>
							<input type="text" name="q" value="Search..." id="admincp_search_input" class="admincp_search_input" autocomplete="off" />
					...
					{if is_array($aModulesMenu) && count($aModulesMenu)}	
							<li class="main_menu_link_li"><a class="main_menu_link" href="#">Modules</a>
						<div class="main_sub_menu">	
