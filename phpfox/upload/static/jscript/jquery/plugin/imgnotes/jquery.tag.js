...
$Core.photo_tag =
{
	...
	{		
		...
		$(function() 
		{
			...
			this.sHtml += '<input autocomplete="off" size="20" class="v_middle" type="text" name="' + $Core.photo_tag.aParams['name'] + '[note]" id="NoteNote" value="" onkeydown="$.ajaxCall(\'friend.searchDropDown\', \'search=\' + this.value + \'&amp;div_id=js_photo_tag_search_content&amp;input_id=js_tag_user_id&amp;text_id=NoteNote\', \'GET\');" />';
