 ...
 * @author  		Raymond Benc
 * @package  		Module_User
 * @version 		$Id: auth.class.php 3324 2011-10-20 08:18:50Z Raymond_Benc $
 */
class User_Service_Auth extends Phpfox_Service
{
	...
	public function login($sLogin, $sPassword, $bRemember = false, $sType = 'email', $bNoPasswordCheck = false)
	{
		...
		if (!defined('PHPFOX_INSTALLER') && Phpfox::getParam('user.brute_force_time_check') > 0)
		{
	...
	*/
	public function handleStatus()
	{
		...
		if (Phpfox::getUserParam('core.user_is_banned') === true)
		{			
