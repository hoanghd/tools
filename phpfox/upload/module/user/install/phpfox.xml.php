...
You can try to log in again in {iUnlockTimeOut} minutes.]]></phrase>
		...
		<phrase module_id="user" version_id="3.0.0beta3" var_name="setting_new_user_terms_confirmation" added="1315851732"><![CDATA[<title>Terms & Privacy Confirmation</title><info>Enable this option if users must confirm that they understand and have ready over your sites terms and privacy policies.</info>]]></phrase>
		...
		<phrase module_id="user" version_id="3.0.0beta4" var_name="setting_enable_relationship_status" added="1317129649"><![CDATA[<title>Enable Relationships</title><info>If you would like your users to have the ability to set their relationship statues on your community enable this feature.</info>]]></phrase>
		...
		<phrase module_id="user" version_id="3.0.0beta5" var_name="full_name_liked_your_status_update_content" added="1319468529"><![CDATA[{full_name} liked your status update "{content}"]]></phrase>
