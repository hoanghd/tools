 ...
 * @author  		Raymond Benc
 * @package 		Phpfox
 * @version 		$Id: filter.html.php 3335 2011-10-20 17:26:57Z Raymond_Benc $
 */
...
{/if}
	...
	<a href="#" id="js_user_browse_advanced_link" onclick="$('#js_user_browse_advanced').show(); return false;">{phrase var='user.advanced_filters'}</a>
