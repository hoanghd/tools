...
<div class="user_tooltip_info">
	...
	{if $aUser.page.total_like == 1}{phrase var='user.1_member'}
	{elseif $aUser.page.total_like > 1}{phrase var='user.total_members' total=$aUser.page.total_like|number_format}{/if}	
	{else}
	{if $aUser.page.total_like == 1}{phrase var='user.1_person_likes_this'}
	{elseif $aUser.page.total_like > 1}{phrase var='user.total_people_like_this' total=$aUser.page.total_like|number_format}{/if}
	{/if}
	{else}
