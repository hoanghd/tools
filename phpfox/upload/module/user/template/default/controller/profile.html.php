 ...
 * @author  		Raymond Benc
 * @package 		Phpfox
 * @version 		$Id: profile.html.php 3303 2011-10-17 09:57:14Z Miguel_Espinoza $
 */
				...
				<span id="relation_with">
					<span id="relation_with_message">with:</span>
						<div class="edit_friend_relation">
										...
										<div style="margin-left:60px;">Pending Confirmation</div>
										{/if}
						</div>
						{literal}
						<script type="text/javascript">
							$Core.searchFriends({
								...
								'max_search': 10,
								'input_name': 'friends',
								'default_value': {/literal}{if isset($aForms.with_user) && $aForms.with_user.with_user_id > 0}'{$aForms.with_user.full_name}' {else} 'Search friends by their name...'{/if}{literal},
