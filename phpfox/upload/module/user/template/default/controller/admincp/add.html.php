...
{/if}
	...
	<div class="table">
		...
		<div class="table_right">
			...
			<div class="extra_info">
				<a href="#" onclick="tb_show('{phrase var='user.edit_profile_picture' phpfox_squote=true}', $.ajaxBox('user.changePicture', 'height=150&width=500&user_id={$aUser.user_id}')); return false;">
