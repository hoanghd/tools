 ...
 * @author  		Raymond Benc
 * @package  		Module_User
 * @version 		$Id: add.html.php 2861 2011-08-21 18:27:39Z Raymond_Benc $
 */
...
{else}
<form method="post" action="{url link='admincp.user.group.add'}" onsubmit="$Core.ajaxMessage(); $(this).ajaxCall('user.updateSettings'); return false;">	
	<div><input type="hidden" name="id" value="{$aForms.user_group_id}" /></div>	
	<div class="table_header">
