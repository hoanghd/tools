 ...
 * @author  		Raymond Benc
 * @package  		Module_Blog
 * @version 		$Id: process.class.php 3304 2011-10-17 11:51:55Z Miguel_Espinoza $
 */
class Blog_Service_Process extends Phpfox_Service 
{
	...
	public function update($iId, $iUserId, $aVals, &$aRow = null)
	{
		...
		$aUpdate = array(
			...
			'privacy_comment' => (isset($aVals['privacy_comment']) ? $aVals['privacy_comment'] : '0'),
			'post_status' => (isset($aVals['post_status']) ? $aVals['post_status'] : '1'),
			'total_attachment' => Phpfox::getService('attachment')->getCountForItem($iId, 'blog')
		);		
		...
		if ($aRow !== null && $aRow['post_status'] == '2' && $aVals['post_status'] == '1' && $aVals['privacy'] == '1')
		{	
