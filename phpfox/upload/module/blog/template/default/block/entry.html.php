 ...
 * @author  		Raymond Benc
 * @package  		Module_Blog
 * @version 		$Id: entry.html.php 3342 2011-10-21 12:59:32Z Raymond_Benc $
 */
	...
	<div class="row_title">	
		...
		<div class="row_title_info">
			...
			<span id="js_blog_edit_title{$aItem.blog_id}">
				<a href="{permalink module='blog' id=$aItem.blog_id title=$aItem.title}" id="js_blog_edit_inner_title{$aItem.blog_id}" class="link ajax_link">{$aItem.title|clean|shorten:55:'...'|split:40}</a>
			</span>
		...
		<div class="blog_content">
			<div id="js_blog_edit_text{$aItem.blog_id}">	
				...
				{if isset($bBlogView)}
					...
					{else}
					{$aItem.text|parse|highlight:'search'|split:55|shorten:$iShorten:'See More':true}				
				{/if}
				</div>			
			</div>	
