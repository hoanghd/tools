...
<a href="{link}">{link}</a>]]></phrase>
		...
		<phrase module_id="mail" version_id="2.0.7" var_name="setting_disallow_select_of_recipients" added="1289312477"><![CDATA[<title>Disallow Selecting Not Allowed Receipients</title><info>When this setting is enabled the script will run an extra check on each target user when selecting who will receive an internal mail.
