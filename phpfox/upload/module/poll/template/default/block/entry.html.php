...
{if isset($bIsViewingPoll)}
	...
	{if Phpfox::getUserParam('poll.poll_can_moderate_polls') || $aPoll.bCanEdit}    
	<div class="item_bar">
	...
	<div class="vote_holder_{$aPoll.poll_id}">		
		...
		<div class="row_title">
			...
			<div class="row_title_info">
				<span id="poll_view_{$aPoll.poll_id}"><a href="{permalink module='poll' id=$aPoll.poll_id title=$aPoll.question}" id="poll_inner_title_{$aPoll.poll_id}" class="link">{$aPoll.question|clean}</a></span>		
