 ...
 * @author  		Raymond Benc
 * @package 		Phpfox
 * @version 		$Id: add.html.php 3116 2011-09-16 09:46:03Z Miguel_Espinoza $
 */
	...
	{/if}		
		...
		*}
		...
		<div class="table">
			...
			<div class="table_right">
				<label><input type="radio" name="val[on_signup]" value="1" class="v_middle checkbox" {value type='checkbox' id='on_signup' default='1'}/>{phrase var='custom.yes'}</label>
				<label><input type="radio" name="val[on_signup]" value="0" class="v_middle checkbox" {value type='checkbox' id='on_signup' default='0' selected=true}/>{phrase var='custom.no'}</label>
			</div>
		</div>			
