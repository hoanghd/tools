			...
			<div class="table_right">
				...
				<input type="radio" name="custom[{$aField.field_id}]" value="{$aOption.option_id}"{value id=''$aOption.option_id'' type='radio' default=''$aOption.option_id''} class="js_custom_search">{phrase var=$aOption.phrase_var_name} <br />
					...
					{elseif $aField.var_type == 'checkbox'}
						{foreach from=$aField.options item=aOption}
				<input type="checkbox" name="custom[{$aField.field_id}][{$aOption.option_id}]" value="{$aOption.option_id}"{value id=''$aOption.option_id'' parent=''$aField.field_id'' type='checkbox' default=''$aOption.option_id''} class="js_custom_search">{phrase var=$aOption.phrase_var_name} <br />
						{/foreach}
					{/if}
			</div>
			<div class="clear"></div>
