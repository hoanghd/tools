 ...
 * @version 		$Id: core.class.php 3342 2011-10-21 12:59:32Z Raymond_Benc $
 */
class Core_Service_Core extends Phpfox_Service 
{
	...
	{		
		$aRows = $this->database()->select('b.block_id,b.title, b.module_id, b.component, b.location, b.can_move')
