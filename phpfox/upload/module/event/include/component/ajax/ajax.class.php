...
class Event_Component_Ajax_Ajax extends Phpfox_Ajax
{
	...
	public function moderation()
	{
		...
		switch ($this->get('action'))
		{
			case 'approve':
				...
				$this->updateCount();
				$sMessage = 'Event(s) successfully approved.';
				break;			
			case 'delete':
				...
				$sMessage = 'Event(s) successfully deleted.';
				break;
		}
	...
	public function addFeedComment()
	{
		...
		$aCallback = array(
			...
			'subject' => Phpfox::getUserBy('full_name') . ' wrote a comment on your event "' . $aEvent['title'] . '".',
			'message' => "" . Phpfox::getUserBy('full_name') . " wrote a comment on your event \"<a href=\"" . $sLink . "\">" . $aEvent['title'] . "</a>\".\nTo see the comment thread, follow the link below:\n<a href=\"" . $sLink . "\">" . $sLink . "</a>",
