 ...
 * @author  		Raymond Benc
 * @package 		Phpfox
 * @version 		$Id: add.html.php 3342 2011-10-21 12:59:32Z Raymond_Benc $
 */
...
{/if}
	<div id="js_event_block_detail" class="js_event_block page_section_menu_holder">
		...
		<div class="table" id="js_event_add_end_time"{if !$bIsEdit} style="display:none;"{/if}>
			...
			<div class="table_right">
				{select_date prefix='end_' start_year='current_year' end_year='+1' field_separator=' / ' field_order='MDY' default_all=true add_time=true start_hour='+4' time_separator='event.time_separator'}
			</div>
		</div>		
