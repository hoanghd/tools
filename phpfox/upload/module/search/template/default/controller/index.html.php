 ...
 * @version 		$Id: index.html.php 2908 2011-08-26 19:02:53Z Raymond_Benc $
 */
...
<div id="feed_view_more">
		<a href="#" onclick="$(this).html($.ajaxProcess('{phrase var='feed.loading'}')); $.ajaxCall('search.viewMore', '{$sNextPage}', 'GET'); return false;" class="global_view_more no_ajax_link">View More</a>
</div>
{else}
{if PHPFOX_IS_AJAX}
