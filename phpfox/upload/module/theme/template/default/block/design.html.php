 ...
 * @author  		Raymond Benc
 * @package 		Phpfox
 * @version 		$Id: design.html.php 3342 2011-10-21 12:59:32Z Raymond_Benc $
 */
	...
	<div class="js_designer_section" id="js_designer_css" style="display:none;">		
		<form method="post" action="{$aDesigner.design_page}" onsubmit="$('.js_save_css_code_button').addClass('disabled'); $('#js_save_css_code').show(); $(this).ajaxCall('theme.processCss'); return false;">
			...
			<div class="style_submit_box">
				...
				<input type="submit" value="{phrase var='theme.save'}" name="save" class="button js_save_css_code_button" onclick="action.value = this.value"/>
				<input type="submit" value="{phrase var='theme.preview'}" name="preview" class="button js_save_css_code_button"  onclick="action.value = this.value" />
