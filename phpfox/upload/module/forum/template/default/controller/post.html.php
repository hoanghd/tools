...
<div class="view_item_link">
	<a href="{permalink module='forum.thread' id=$aForms.thread_id title=$aForms.title}">View Thread</a>
</div>
{/if}
...
{/if}
	...
	<div class="table_clear">
		<a href="#" class="mobile_view_options">View Additional Options</a>
		<input type="submit" value="{if isset($iEditId)}Update{else}{phrase var='forum.submit'}{/if}" class="button" />
	</div>		
	{/if}
	<div{if Phpfox::isMobile()} id="js_mobile_form_holder" style="display:none;"{/if}>
		...
		<div class="table_clear" id="js_forum_submit_button">
			<ul class="table_clear_button">
				<li><input type="submit" value="{if isset($iEditId)}Update{else}{phrase var='forum.submit'}{/if}" class="button" /></li>
