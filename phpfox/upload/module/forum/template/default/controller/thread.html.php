	...
	<ul class="sub_menu_bar">
		...
		<li class="sub_menu_bar_li">
			...
			<div class="link_menu dropContent">
				...
				{/if}
				{if $bCanEditThread}
					<li><a href="{if $aCallback === null}{url link='forum.post.thread' edit=$aThread.thread_id}{else}{url link='forum.post.thread' module='group' item=$aCallback.group_id edit=$aThread.thread_id}{/if}">{phrase var='forum.edit_thread'}</a></li>
				{/if}
				{if $aCallback === null}
