						...
						<ul>
							{if !isset($aPost.aFeed.feed_mini)}
								...
								{if $aPost.aFeed.privacy > 0 && $aPost.aFeed.user_id == Phpfox::getUserId()}
									<li><div class="js_hover_title">{img theme='layout/privacy_icon.png' alt=$aPost.aFeed.privacy}<span class="js_hover_info">{$aPost.aFeed.privacy|privacy_phrase}</span></div></li>	
									<li><span>&middot;</span></li>
								{/if}
							{/if}
							...
							{/if}
							{if isset($aPost.aFeed.report_module) && isset($aPost.aFeed.force_report)}				
								<li><span>&middot;</span></li>
