 ...
 * @version 		$Id: index.class.php 3335 2011-10-20 17:26:57Z Raymond_Benc $
 */
	...
	{		
		...
		switch ($sView)
		{
			case 'list':
				...
				{
					$this->search()->setCondition('AND fld.list_id = ' . (int) $aList['list_id'] . ' AND friend.user_id = ' . Phpfox::getUserId());
