...
$Core.searchFriendsInput =
{
	...
	init: function($aParams)
	{
		...
		{
			this.aParams['search_input_id'] = 'search_input_name_' + Math.random();
		}
	...
	{		
		...
		{		
			if (this._get('global_search')){
				$sHtml += '<li><a href="#" class="holder_notify_drop_link" onclick="$(this).parents(\'form:first\').submit(); return false;">Show more results for "' + htmlspecialchars($oObj.value) + '"</a></li>';
			}
