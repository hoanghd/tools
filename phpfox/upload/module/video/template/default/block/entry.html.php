...
{plugin call='video.template_block_entry_1'}
	<div class="js_video_parent main_video_div_container {if isset($aVideo.is_sponsor) && $aVideo.is_sponsor}row_sponsored{/if} {if isset($aVideo.is_featured) && $aVideo.is_featured}row_featured_image{/if}" id="js_video_id_{$aVideo.video_id}">	
