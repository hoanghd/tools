 ...
 * @author  		Raymond_Benc
 * @package 		Phpfox
 * @version 		$Id: preview.html.php 2295 2011-02-04 16:04:06Z Raymond_Benc $
 */
...
<div class="attachment_body">
	...
	<div class="attachment_pager">
		<ul>
			<li class="no_link"><a href="#" onclick="return $Core.changeDefaultAttachmentImage(this, 'previous');" class="previous first">Previous</a></li>
			<li><a href="#" onclick="return $Core.changeDefaultAttachmentImage(this, 'next');" class="next">Next</a></li>
			<li class="counter"><span id="js_attachment_link_counter">1 of {$iTotalImages}</span><span class="small">Choose a Thumbnail</span></li>
		</ul>
		<div class="clear"></div>
	</div>
	{/if}
	...
	<div>
		<label><input type="checkbox" name="attachment_link_checkbox" value="0" onchange="$Core.toggleAttachmentLinkThumb(this);" > No Thumbnail</label>
	</div>	
