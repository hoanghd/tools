...
<div class="message">
	{phrase var='apps.would_you_like_to_view_this_app_without_installing_it'} <input type="button" class="button" value="{phrase var='apps.yes'}" onclick="window.location.href='{permalink module='apps' id=$aApp.app_id title=$aApp.app_title}force_1/';" />
</div>
{/if}
