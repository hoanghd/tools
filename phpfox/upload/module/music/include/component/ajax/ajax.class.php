	...
	public function moderation()
	{
		...
		switch ($this->get('action'))
		{
			case 'approve':
				...
				$this->updateCount();
				$sMessage = 'Songs(s) successfully approved.';
				break;			
			case 'delete':
				...
				$sMessage = 'Songs(s) successfully deleted.';
				break;
			case 'feature':
				...
				$sMessage = 'Songs(s) successfully featured.';
				break;
			case 'un-feature':
				Phpfox::getUserParam('music.can_feature_songs', true);
				foreach ((array) $this->get('item_moderate') as $iId)
				...
				$sMessage = 'Songs(s) successfully un-featured.';
				break;
		}
	...
	public function moderationAlbum()
	{
		...
		{		
			case 'delete':
				...
				$sMessage = 'Albums(s) successfully deleted.';
				break;
			case 'feature':
				...
				$sMessage = 'Albums(s) successfully featured.';
				break;
			case 'un-feature':
				Phpfox::getUserParam('music.can_feature_music_albums', true);
				foreach ((array) $this->get('item_moderate') as $iId)
				...
				$sMessage = 'Albums(s) successfully un-featured.';
				break;
		}
