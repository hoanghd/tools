 ...
 * @version 		$Id: add.html.php 2197 2010-11-22 15:26:08Z Raymond_Benc $
 */
...
{else}
<form method="post" action="{url link='admincp.newsletter.add'}">
	...
	<div class="table_clear">
		<input type="button" value="{phrase var='newsletter.show_plain'}" class="button js_txtPlain" onclick="$Core.Newsletter.showPlain();">
		<input type="submit" value="{phrase var='newsletter.send_now'}" class="button">
	</div>
