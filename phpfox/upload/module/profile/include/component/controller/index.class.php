 ...
 * @version 		$Id: index.class.php 3333 2011-10-20 13:34:25Z Miguel_Espinoza $
 */
class Profile_Component_Controller_Index extends Phpfox_Component 
{
	...
	{	
		...
		if (Phpfox::getService('user.privacy')->hasAccess($aRow['user_id'], 'rss.can_subscribe_profile'))
		{
