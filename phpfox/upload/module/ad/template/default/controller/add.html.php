 ...
 * @author  		Raymond_Benc
 * @package 		Phpfox
 * @version 		$Id: add.html.php 3296 2011-10-12 13:29:57Z Raymond_Benc $
 */
...
{else}
{if $bIsEdit}
<form method="post" action="{url link='ad.add'}">
...
<div id="js_upload_image_holder_frame" style="display:none;">	
	<div id="js_upload_image_holder" style="position:absolute; z-index:999; display:none;" class="ajax_link_reset">
		<form method="post" action="{url link='ad.image'}" target="upload_ad_iframe" enctype="multipart/form-data">			
			...
			<input id="js_form_upload_file" type="file" name="image" onchange="$('#js_upload_image_holder').hide(); $('#js_image_holder_message').show(); $(this).parent('form').submit();" />
		</form>
	</div>
	...
	<div id="js_create_ad" class="hide_sub_block">
		...
		<div class="table">
			...
			<div class="table_right">
				...
				<div id="js_image_holder_link" style="display:none;"><a href="#" onclick="$(this).parent().hide(); $('.js_ad_image').hide(); $('#js_upload_image_holder').show(); $('#js_form_upload_file').val(''); $.ajaxCall('ad.changeImage', 'image=' + encodeURIComponent($('#js_image_id').val())); return false;">{phrase var='ad.change_image'}</a></div>
