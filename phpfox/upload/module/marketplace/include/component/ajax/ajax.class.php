	...
	public function moderation()
	{
		...
		switch ($this->get('action'))
		{
			case 'approve':
				...
				$this->updateCount();
				$sMessage = 'Listing(s) successfully approved.';
				break;			
			case 'delete':
				...
				$sMessage = 'Listing(s) successfully deleted.';
				break;
			case 'feature':
				...
				$sMessage = 'Listing(s) successfully featured.';
				break;
			case 'un-feature':
				Phpfox::getUserParam('marketplace.can_feature_listings', true);
				foreach ((array) $this->get('item_moderate') as $iId)
				...
				$sMessage = 'Listing(s) successfully un-featured.';
				break;
		}
