 ...
 * @author  		Raymond Benc
 * @package 		Phpfox
 * @version 		$Id: add.html.php 3346 2011-10-24 15:20:05Z Raymond_Benc $
 */
		...
		<div class="table">
			...
			<div class="table_right">
				...
				{foreach from=$aCurrencies key=sCurrency item=aCurrency}
					<option value="{$sCurrency}"{if $aCurrency.is_default} selected="selected"{/if}>{phrase var=$aCurrency.name}</option>
				{/foreach}
				</select>
