	...
	{				
		...
		*/
		...
		$this->template()
				...
				->setMeta('description',  Phpfox::getPhrase('photo.full_name_s_photo_from_time_stamp', array('full_name' => $aUser['full_name'], 'time_stamp' => Phpfox::getTime(Phpfox::getParam('core.description_time_stamp'), $aPhoto['time_stamp']))) . ': ' . (empty($aPhoto['description']) ? $aPhoto['title'] : $aPhoto['title'] . '.' . $aPhoto['description']))
				...
				->setEditor(array(
					...
					'aForms' => $aPhoto,
					'aCallback' => $aCallback,
					'aPhotoStream' => Phpfox::getService('photo')->getPhotoStream($aPhoto['photo_id'], $aPhoto['album_id'], $aCallback),
