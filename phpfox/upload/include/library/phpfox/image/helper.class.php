 ...
 * @author			Raymond Benc
 * @package 		Phpfox
 * @version 		$Id: helper.class.php 3353 2011-10-25 11:45:16Z Miguel_Espinoza $
 */
...
{	
	...
	public function display($aParams)
	{
		...
		if ($bIsServer === false && !file_exists(str_replace(Phpfox::getParam('core.path'), PHPFOX_DIR, $sSrc)))
		{
			...
			if (preg_match('/file\/pic\/pages\/\[GROUP\](.*)/i', $sSrc, $aMatches) && isset($aMatches[1]))
			{
