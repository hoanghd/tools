 ...
 * @author			Raymond Benc
 * @package 		Phpfox
 * @version 		$Id: locale.class.php 3056 2011-09-09 18:28:44Z Raymond_Benc $
 */
class Phpfox_Locale
{
	/**
	...
	public function getPhrase($sParam, $aParams = array(), $bNoDebug = false, $sDefault = null, $sLang = '')
	{
		...
		if ($sLang != null && $sLang != '' && ($sLang != $this->getLangId()))
		{
	...
	{
		return Phpfox::getPhrase(trim(trim($aMatches[1], "&#039;"), "'"));	
	}
}
