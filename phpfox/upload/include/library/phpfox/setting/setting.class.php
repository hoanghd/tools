 ...
 * @author			Raymond Benc
 * @package 		Phpfox
 * @version 		$Id: setting.class.php 3237 2011-10-07 09:23:54Z Miguel_Espinoza $
 */
					...
					case 'array':
						...
						if ($aRow['var_name'] == 'global_genders')
						{
							...
							foreach ($aTempGenderCache as $aGender)
							{
								...
								$aRows[$iKey]['value_actual'][$aGenderExplode[0]] = array($aGenderExplode[1], $aGenderExplode[2], (isset($aGenderExplode[3]) ? $aGenderExplode[3] : null));
							}
						}
						break;
					case 'drop':
