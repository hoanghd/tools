...
return array(
    ...
    'admin' => array(
        'menu' => array(
            ...
            'setting'    => array( 'add_submenu_page', 'edm-easy-database-management', esc_html__( 'Advanced Settings', EDM_LANG ), esc_html__( 'Advanced Settings', EDM_LANG ), 'manage_options','edm-advanced-settings', 'fn(Default_Setting.index)'),
            'tool'       => array( 'add_submenu_page', 'edm-easy-database-management', esc_html__( 'Export/Import', EDM_LANG ), esc_html__( 'Export/Import', EDM_LANG ), 'manage_options','edm-export-import', 'fn(Default_Tool.index)'),
            'analytics'  => array( 'add_submenu_page', 'edm-easy-database-management', esc_html__( 'Analytics', EDM_LANG ), esc_html__( 'Analytics', EDM_LANG ), 'manage_options','edm-analytics', 'fn(Default_Analytics.index)'),
